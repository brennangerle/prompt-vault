// Script to add demo prompts to the community
...
async function addDemoPrompts() {
  try {
    ...
    for (let i = 0; i < demoPrompts.length; i++) {
      ...
      console.log(`   ${i + 1}. ✓ ${promptData.title}`);
    }
    ...
    console.log('🏷️  Categories created: Code, Business, Creative, Analytics, Marketing, Strategy');
